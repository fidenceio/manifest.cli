...
_manifest_complete() {
    ...
    local top_cmds="config init quickstart plan reconcile status recipe discover update add validate prep refresh docs ship pr doctor security upgrade uninstall version help"
