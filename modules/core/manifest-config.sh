...
set_default_configuration() {
    ...
    export MANIFEST_CLI_DOCS_ARCHIVE_KEEP_RECENT="${MANIFEST_CLI_DOCS_ARCHIVE_KEEP_RECENT:-1}"
    export MANIFEST_CLI_DOCS_ARCHIVE_TRIGGER="${MANIFEST_CLI_DOCS_ARCHIVE_TRIGGER:-minor_or_major}"
