...
set_default_configuration() {
    ...
    export MANIFEST_CLI_DOCS_GENERATE_SITE="${MANIFEST_CLI_DOCS_GENERATE_SITE:-false}"
    ...
    export MANIFEST_CLI_DOCS_SITE_ENABLE_PAGES="${MANIFEST_CLI_DOCS_SITE_ENABLE_PAGES:-false}"
    export MANIFEST_CLI_DOCS_SITE_PAGES_REQUIRED="${MANIFEST_CLI_DOCS_SITE_PAGES_REQUIRED:-false}"
