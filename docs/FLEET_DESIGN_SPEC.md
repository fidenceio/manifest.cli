...
Fleet docs generation can refresh per-service docs and generate a managed Jekyll docs site. Docs-site generation is **opt-in** (`docs.generate.site`, default `false`) and covered in [DOCS_SITE.md](DOCS_SITE.md).
