...
MANIFEST_CLI_TIME_SERVER1="https://www.cloudflare.com/cdn-cgi/trace"
MANIFEST_CLI_TIME_TIMEOUT=20
MANIFEST_CLI_TIME_RETRIES=10
MANIFEST_CLI_TIME_VERIFY=true
MANIFEST_CLI_DEBUG=false
...
### Security & Compliance
- `MANIFEST_CLI_TIME_SERVER1` - Primary HTTPS time server (default: https://www.cloudflare.com/cdn-cgi/trace)
- `MANIFEST_CLI_TIME_VERIFY` - Verify timestamps (true for compliance)
